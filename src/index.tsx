...
export class RecordVerify {
  ...
  open(options: RecordVerifyOpenOptions): void {
    ...
    loader.style.cssText = 'height:590px;display:flex;align-items:center;justify-content:center;background:#fff;';
    loader.innerHTML = '<div style="width:32px;height:32px;border:3px solid #e5e7eb;border-top-color:#022c22;border-radius:50%;animation:recordSpin 0.7s linear infinite;"></div>';
